...
from convex_hull import convex_hull, convex_hull_internal_points, convex_hull_all_internal_points
		...
		while True:
			...
			if flag_source and flag_target:
				...
				if (pos_frame-1) % frame_rate_for_swap == 0 :
					...
					try:
						hull1, hull2 = convex_hull_all_internal_points(points1, points2, face_landmarks_dict_1,face_landmarks_dict_2)
					except KeyboardInterrupt:
						sys.exit()
					except:
					...
					try:
						output, points2 = doOpticalFlow(output, points2, target_frame, prev_target_frame, pos_frame)
						out.write(output)
						prev_target_frame = target_frame
					except KeyboardInterrupt:
						sys.exit()
